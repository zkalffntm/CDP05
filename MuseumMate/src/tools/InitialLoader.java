...
public class InitialLoader extends Thread
{
	...
	public void run()
	{
		...
		reclist.add(new Recommandation(0, "샘플1", "컨셉설명", new int[]{1, 2, 3, 4, 5, 6, 7}));
		reclist.add(new Recommandation(0, "샘플2", "컨셉설명", new int[]{3, 5, 7}));
		reclist.add(new Recommandation(0, "샘플3", "컨셉설명", new int[]{1, 2, 4, 7}));
