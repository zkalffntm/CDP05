...
public abstract class AbstractClientThread extends Thread {
	 ...
	 *          클라이언트 소켓
	 */
	public AbstractClientThread(AbstractServerThread serverThread, Socket clientSocket) {
	 ...
	 *           기타 사용자 정의를 포함한 예외
	 */
	protected abstract void process(JSONObject recvJson) throws JSONException, SQLException, Exception;
}
